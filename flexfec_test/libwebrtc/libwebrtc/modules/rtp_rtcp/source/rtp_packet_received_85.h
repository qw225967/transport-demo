 ...
 */
#ifndef MODULES_RTP_RTCP_SOURCE_RTP_PACKET_RECEIVED_85_H_
#define MODULES_RTP_RTCP_SOURCE_RTP_PACKET_RECEIVED_85_H_
...
class RtpPacketReceived : public RtpPacket {
 public:
  ...
  webrtc::NtpTime capture_ntp_time() const { return capture_time_; }
  void set_capture_ntp_time(webrtc::NtpTime time) { capture_time_ = time; }
...
#endif  // MODULES_RTP_RTCP_SOURCE_RTP_PACKET_RECEIVED_85_H_
