...
#ifndef MODULES_RTP_RTCP_SOURCE_VIDEO_FEC_GENERATOR_85_H_
#define MODULES_RTP_RTCP_SOURCE_VIDEO_FEC_GENERATOR_85_H_
...
class VideoFecGenerator {
 public:
  ...
  virtual absl::optional<webrtc::RtpState> GetRtpState() = 0;
};

}  // namespace webrtc
#endif  // MODULES_RTP_RTCP_SOURCE_VIDEO_FEC_GENERATOR_85_H_
