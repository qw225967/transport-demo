...
#ifndef MODULES_RTP_RTCP_SOURCE_ULPFEC_GENERATOR_85_H_
#define MODULES_RTP_RTCP_SOURCE_ULPFEC_GENERATOR_85_H_
...
class UlpfecGenerator : public VideoFecGenerator {
 ...
 public:
  ...
  absl::optional<webrtc::RtpState> GetRtpState() override { return absl::nullopt; }
...
#endif  // MODULES_RTP_RTCP_SOURCE_ULPFEC_GENERATOR_85_H_
