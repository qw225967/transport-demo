...
#ifndef MODULES_RTP_RTCP_SOURCE_FORWARD_ERROR_CORRECTION_85_H_
#define MODULES_RTP_RTCP_SOURCE_FORWARD_ERROR_CORRECTION_85_H_
...
class ForwardErrorCorrection {
 ...
 private:
  ...
  uint8_t packet_masks_[webrtc::kUlpfecMaxMediaPackets * webrtc::kUlpfecMaxPacketMaskSize];
  uint8_t tmp_packet_masks_[webrtc::kUlpfecMaxMediaPackets * webrtc::kUlpfecMaxPacketMaskSize];
...
#endif  // MODULES_RTP_RTCP_SOURCE_FORWARD_ERROR_CORRECTION_85_H_
