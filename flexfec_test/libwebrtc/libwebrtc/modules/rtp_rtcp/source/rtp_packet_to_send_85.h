 ...
 */
#ifndef MODULES_RTP_RTCP_SOURCE_RTP_PACKET_TO_SEND_85_H_
#define MODULES_RTP_RTCP_SOURCE_RTP_PACKET_TO_SEND_85_H_
...
class RtpPacketToSend : public RtpPacket {
 public:
  ...
  using Type = webrtc::RtpPacketMediaType;
  ...
  void set_packet_type(webrtc::RtpPacketMediaType type) { packet_type_ = type; }
  absl::optional<webrtc::RtpPacketMediaType> packet_type() const {
    return packet_type_;
  }
  ...
  void set_packetization_finish_time_ms(int64_t time) {
    SetExtension<webrtc85::VideoTimingExtension>(
        webrtc::VideoSendTiming::GetDeltaCappedMs(capture_time_ms_, time),
        webrtc85::VideoTimingExtension::kPacketizationFinishDeltaOffset);
  }

  void set_pacer_exit_time_ms(int64_t time) {
    SetExtension<webrtc85::VideoTimingExtension>(
        webrtc::VideoSendTiming::GetDeltaCappedMs(capture_time_ms_, time),
        webrtc85::VideoTimingExtension::kPacerExitDeltaOffset);
  }

  void set_network_time_ms(int64_t time) {
    SetExtension<webrtc85::VideoTimingExtension>(
        webrtc::VideoSendTiming::GetDeltaCappedMs(capture_time_ms_, time),
        webrtc85::VideoTimingExtension::kNetworkTimestampDeltaOffset);
  }

  void set_network2_time_ms(int64_t time) {
    SetExtension<webrtc85::VideoTimingExtension>(
        webrtc::VideoSendTiming::GetDeltaCappedMs(capture_time_ms_, time),
        webrtc85::VideoTimingExtension::kNetwork2TimestampDeltaOffset);
  }
 ...
 private:
  ...
  absl::optional<webrtc::RtpPacketMediaType> packet_type_;
...
#endif  // MODULES_RTP_RTCP_SOURCE_RTP_PACKET_TO_SEND_85_H_
