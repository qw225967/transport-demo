...
TEST(GainController2, ToString) {
  // Tests GainController2::ToString(). Only mytest the enabled property.
  AudioProcessing::Config::GainController2 config;
...
INSTANTIATE_TEST_SUITE_P(
    ...
    FixedDigitalTest,
    ::testing::Values(
        // When gain < |mytest::kLimiterMaxInputLevelDbFs|, the limiter will not
        ...
        FixedDigitalTestParams(0.1,
                               ...
                               48000,
                               false),
        // When gain > |mytest::kLimiterMaxInputLevelDbFs|, the limiter will
        // saturate the signal (at any sample rate).
