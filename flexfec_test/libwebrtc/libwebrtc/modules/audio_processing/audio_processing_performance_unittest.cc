...
// Variant of APM processing settings to use in the mytest.
...
// Class for managing the mytest simulation.
...
bool TimedThreadApiProcessor::Process() {
  ...
  // TODO(tommi): This loop may affect the performance of the mytest that it's
