...
mytest the APM module. Each pair consists of a noisy input and a reference signal.
...
class TestDataGenerator(object):
  ...
  An mytest data generator generates one or more pairs.
  """
  ...
  def __init__(self, output_directory_prefix):
    ...
    # Init dictionaries with one entry for each mytest data generator
...
class AdditiveNoiseTestDataGenerator(TestDataGenerator):
  ...
  def _Generate(
      self, input_signal_filepath, test_data_cache_path, base_output_path):
    """Generates mytest data pairs using environmental noise.
...
class ReverberationTestDataGenerator(TestDataGenerator):
  ...
  def _Generate(
      self, input_signal_filepath, test_data_cache_path, base_output_path):
    """Generates mytest data pairs using reverberation noise.
