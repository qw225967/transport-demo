...
// efficiently compute pair-wise scores. This mytest verifies that the evolution
...
TEST(RnnVadTest, SymmetricMatrixBufferUseCase) {
  ...
  // pairs of integers with which this mytest can easily check that the evolution
