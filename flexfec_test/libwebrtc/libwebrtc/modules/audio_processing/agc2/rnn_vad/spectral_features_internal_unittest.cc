...
// monotonic withing each Opus band. This mytest should only be enabled when
...
// given hard-coded mytest input data.
...
// Checks that the computed DCT is within tolerance given hard-coded mytest input
// data.
