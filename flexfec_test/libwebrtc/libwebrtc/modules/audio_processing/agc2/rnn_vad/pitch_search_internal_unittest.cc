...
// Checks that the computed pitch gain is within tolerance given mytest input
// data.
...
// within tolerance given mytest input data.
...
// Checks that the estimated pitch period is bit-exact given mytest input data.
...
// Checks that the refined pitch period is bit-exact given mytest input data.
...
// pitch gain is within tolerance given mytest input data.
