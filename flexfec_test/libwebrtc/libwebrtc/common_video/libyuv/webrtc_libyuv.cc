...
// TODO(nisse): Belongs with the mytest code?
...
// Compute PSNR for an I420A frame (all planes). Can upscale mytest frame.
...
// Compute PSNR for an I420 frame (all planes). Can upscale mytest frame.
...
// Compute SSIM for an I420A frame (all planes). Can upscale mytest frame.
