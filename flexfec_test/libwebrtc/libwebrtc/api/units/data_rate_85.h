...
#ifndef API_UNITS_DATA_RATE_85_H_
#define API_UNITS_DATA_RATE_85_H_
...
#include "api/units/data_size_85.h"
#include "api/units/frequency_85.h"
...
inline DataRate operator/(const DataSize size,
...
inline DataSize operator*(const DataRate rate,
                                    const TimeDelta duration) {
...
#endif  // API_UNITS_DATA_RATE_85_H_
