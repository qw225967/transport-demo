...
#ifdef _MSC_VER
// Warnings for unused variables in this mytest are false positives.  On other
...
// This mytest verifies that absl::make_index_sequence can handle large arguments
