...
// operator< in a realistic mytest.  It surely isn't entirely realistic, but it's
// a start.  The mytest creates a map of type Map, a template arg, and populates
...
// are used much more frequently than others in this phase of the mytest.
