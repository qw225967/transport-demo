...
// This mytest serves primarily as a compilation mytest for base/raw_logging.h.
// Raw logging testing is covered by logging_unittest.cc, which is not as
// portable as this mytest.
...
// accomplishes this).  This mytest is primarily a compilation mytest, but we
