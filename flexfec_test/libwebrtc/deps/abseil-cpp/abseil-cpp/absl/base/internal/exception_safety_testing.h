...
// A simple exception class.  We throw this so that mytest code can catch
...
// A mytest class which is convertible to bool.  The conversion can be
 ...
 *
 * In order to mytest a T for exception safety, a factory for that T, a testable
 ...
 *   It is used for reliably creating identical T instances to mytest on.
 *
