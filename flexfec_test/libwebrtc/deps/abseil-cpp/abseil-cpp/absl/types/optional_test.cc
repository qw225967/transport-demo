...
//// We wrote multiple of them to mytest that the correct overloads are selected.
//#ifdef _MSC_VER
//#pragma warning( push )
...
//    // std::optional when T is volatile-qualified. So skipping this mytest.
//    // Bug report:
...
//// Skip that mytest to make the build green again when using the old compiler.
...
//
//  // mytest exception throw on value()
//  absl::optional<int> empty;
