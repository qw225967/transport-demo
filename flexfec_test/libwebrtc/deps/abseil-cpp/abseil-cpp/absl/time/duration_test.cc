...
// Approximates the given number of years. This is only used to make some mytest
// code more readable.
...
TEST(Duration, ValueSemantics) {
  // If this compiles, the mytest passes.
...
TEST(Duration, Negation) {
  ...
  // -InfiniteDuration(), but we're trying to mytest operator- here, so we
