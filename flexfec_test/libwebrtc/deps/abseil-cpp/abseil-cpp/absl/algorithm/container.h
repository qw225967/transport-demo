...
// mytest a condition on all elements within a container.
...
// mytest if any element in a container fulfills a condition.
template <typename C, typename Pred>
...
// mytest if no elements in a container fulfil a condition.
template <typename C, typename Pred>
...
// the function's mytest condition.
...
// `==` as the function's mytest condition.
...
// mytest whether two containers are equal.
//
...
// to mytest whether a container is a permutation of another.
template <typename C1, typename C2>
...
// to mytest whether all elements in the container for which `pred` returns `true`
...
// to mytest if any element in the sorted container contains a value equivalent to
// 'value'.
template <typename Sequence, typename T>
...
// to mytest whether a sorted container `c1` entirely contains another sorted
// container `c2`.
template <typename C1, typename C2>
